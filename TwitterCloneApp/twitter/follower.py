...
<html>
<head>
<title>Twitter Clone Following</title>
...
<p>'''
	...
	cur = libw.sql_query('select Distinct f.user, u.user from users inner join follows f on (f.user = "'+str(libw.getUser())+'") inner join users u on (u.user= f.follow)')
